...
// taco "A(i,j)=B(i,k)*C(k,j)" -f=A:dd:0,1 -f=B:dd:0,1 -f=C:dd:0,1 -s="reorder(i,k,j)" -s="parallelize(i,CPUThread,NoRaces)" -write-source=taco_kernel.c -write-compute=taco_compute.c -write-assembly=taco_assembly.c
